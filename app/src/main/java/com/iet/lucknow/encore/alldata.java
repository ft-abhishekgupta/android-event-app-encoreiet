...
public class alldata {
    ...
    static String team[][]=
            {
                    {"Coordinators","-------------------------","0","arrow"},
                    {"Prabal Singh","", "+919125448910" ,"zprabal"},
                    {"Niharika","","","zniharika"},

                    {"Deputy Coordinators","------------------------------------------","0","arrow"},
                    {"Rajat Anand","","+918574460614","zrajat"},
                    {"Aaditya Rai","","","zaaditya"},
                    {"Treasurer","-------------------","0","arrow"},
                    {"Puneet Agarwal","","+918909137333","zpuneet"},
                    {"Program-Cultural Heads","------------------------------------------------","0","arrow"},
                    {"Suryam Sinha","","","zsuryam"},
                    {"Ankita Anand","","","zankita"},
                    {"Sponsorship Coord.","---------------------------------------","0","arrow"},
                    {"Akshay Chaudhry","","","zakshay"},
                    {"Vishad Saxena","","+918979229396","zvishad"},
                    {"Neelika Chandel","","","zneelika"},
                    {"Anuj Rawat","","+918899412767","zanuj"},
                    ...
                    {"Unmol Srivastava","","","zunmol"},
                    {"Yasharth Srivastava","","","zyasharth"},
                    {"Shivangi Singh","","+917839501037","zshivangi"},
                    {"Arpita Saran Yadav","","","zarpita"},
                    {"Hospitality Coord.","-----------------------------------","0","arrow"},
                    {"Gaurangi Katiyar","","","zgaurangi"},
                    {"Nirmal","","+919412852890","znirmal"},
                    {"Himanshu Premi","","+917071042327","zhimanshu"},
                    {"Supriya Singh Yadav","","","zsupriya"},
                    {"Saijasi Chaubey","","","zsaijasi"},
                    {"Neha Singh","","","blank"},
                    {"Priya Mehrotra","","","zpriyam"},
                    {"Transportation Coord.","-------------------------------------------","0","arrow"},
                    {"Shivam Kapoor","","+919198566709","zshivam"},
                    {"Praveen Rai","","","zpraveen"},
                    ...
                    {"Avaneesh Kaushik","","","zavaneesh"},
                    {"Abhishek Verma","","","zabhishekverma"},
                    {"Aviral","","","zaviral"},
                    {"Rambali Yadav","","","zrambali"},
                    {"Ravikant","","","zravikant"},
                    {"Sachin Yadav","","","zsachin"},
                    {"Avinash Yadav","","","zavinash"},
                    {"Ajay Kacher","","","zajay"},
                    {"Roshan Pandey","","","zroshan"},
                    {"Prateek Anand","","","zprateek"},
                    {"Shubham Yadav","","","zshubhamyadav"},
                    {"Akhil Gupta","","","zakhil"},
                    {"Anoj Yadav","","","zanoj"},
                    ...
                    {"Gaurav Singh","","+919452038138","zgaurav"},
                    {"Aastha Singh","","","zaastha"},
                    {"Drama Heads","----------------------------","0","arrow"},
                    {"Saurabh Gautam","","+917379049526","zsaurabhgautam"},
                    {"Akash Patel","","","zakashpatel"},
                    {"Literary Heads","-----------------------------","0","arrow"},
                    {"Anshul Verma","","+918756340456","zanshul"},
                    {"Priya Srivastav","","","zpriyas"},
                    {"Fine Arts Heads","-------------------------------","0","arrow"},
                    {"Arun Kr. Gautam","","","zarungautam"},
                    {"Sakshi Agarwal","","","zsakshi"},
                    {"Vogue","--------------","0","arrow"},
                    {"Shubham Arora","","+917895202889","zshubhamarora"},
                    {"Kanishk Gangwar","","+918052645788","zkanishk"},
                    {"Vidushi Saxena","","+918935076551","zvidhushi"},
                    {"Akansha Verma","","","zakansha"},
                    {"Compering","----------------------","0","arrow"},
                    {"Rahul Mishra","","","zrahul"},
                    ...
                    {"Niharika","","","zniharika"},
                    {"Media","------------","0","arrow"},
                    {"Aditya Yadav","","","zadityayadav"},
                    {"Aishwarya Singh","","","zaishwarya"},
                    {"Pragya Bajpai","","","zpragya"},
                    {"Yashaswi Pandey","","+918601383012","zyash"},
                    {"Band Wars Coord.","-----------------------------------","0","arrow"},
                    {"Shubham Singh","","+919634914570","zshubhamsingh"},
                    {"Priyank Srivastav","","","zpriyank"},
                    {"Aurora","-------------","0","arrow"},
                    {"Himanshu Srivastava","","","zhimanshusri"},
                    {"Jyoti Singh","","","zjyotisingh"}
                   };
    ...
    static String day0[][]=
            {
                    ...
                    {"ENCORE Recap ","Main Stage","9:00 PM",""},
                    {"Qawwali","Main Stage","9:30 PM",""}

            };
    static String day1[][]=
            {
                    {"Sur Sangram Prelims","SAC","9:30 AM",""},
                    {"Brush Painting"," Auditorium","10:00 AM",""},
                    {"Mime","Main Stage","10:30 AM",""},
                    {"Marketing Star","Secondary Stage","11:00 AM",""},
                    {"Poetry Slam","Conference Hall","11:30 AM",""},
                    {"Parliamentary Debate","Conference Hall","12:00 PM",""},
                    {"B/W Sketching","Auditorium","12:30 PM",""},
                    {"Logo Logic (LT)","LT","2:00 PM",""},
                    {"Sur Sangram Finals","Main Stage","2:00 PM",""},
                    {"Tattoo Making (A)","Auditorium","2:30 PM",""},
                    {"Skit","Main Stage","4:30 PM",""},
                    {"Third year Dance","Main Stage","5:00 PM",""},
                    {"Allegretto","Main Stage","5:30 PM",""},
                    {"Final Year Dance","Main Stage","6:00 PM",""},
                    {"Vogue","Main Stage","7:30 PM",""},
                    {"DJ Paroma","Main Stage","9:30 PM",""}

            };
    static String day2[][]=
            {
                    {"Razzmatazz Prelims","SAC","9:30 AM",""},
                    {"Modern Painting","Auditorium","10:00 AM",""},
                    {"Creative Writing","New LT","10:30 AM",""},
                    {"Business Quiz","LT","11:00 AM",""},
                    ...
                    {"Two to Tango","Main Stage","4:00 PM",""},
                    {"RJ Show","Main Stage","5:00 PM",""},
    ...
    static String day3[][]=
            {
                    ...
                    {"Band Wars","Secondary Stage","5:00 PM",""},
                    {"Theme Party","SAC","7:00 PM",""},
    ...
    static String posters[][]={{"",""},
            ...
            {"Jubin Nautiyal","gal3"},
            {"Jubin Nautiyal","gal4"},
            {"DJ Candice Redding","gal5"},
            {"DJ Candice Redding","gal6"},
            {"Band Wars","gal7"},
            {"Band Wars","gal7o1"},
            {"Duet Dance Performance","gal8"},
            {"Choreo Team Dance","gal9"},
            {"Main Play by Drama Team","gal10"},
            {"Skit by Drama Team","gal11"},
            {"Fine Arts","gal12"},
            {"Final Year Dance","gal13"},
            {"Grazioso","gal14"},
            {"Vogue","gal15"}
    ...
    static String swaranjali[][]=
            {
                    {"Sur Sangram","sursangram",
                            "Type: Solo/Duet\n" +
    ...
    static String management[][]={
            {"Logo Logic","logologic","" +
                    "Logo logic is an Audio Video quiz.\n" +
                    ...
                    "Sumit   (8938966010)\n" +
                    "Amit   (8447551689)"},
            {"Bussiness Quiz","bussinessquiz","" +
                    "Type: 2-3 Participants\n" +
    ...
    static String literary[][]={
            {"Parliamentary Debate","parliament",
                    "Type: Team\n" +
    ...
    static String finearts[][]={
            {"Modern Painting","modernpainting",
                    "Type : Team\n" +
            ...
            {"Black-White Sketching","blackandwhitesketch",
                    "Type : Individual\n" +
                            "Registration Fee: Rs. 30/-\n" +
                            "Maximum no. of Team Members: 2\n" +
                            "Duration: 2 Hrs\n" +
            ...
            {"T-Shirt Painting","tshirtpainting",
                    "Type : Team\n" +
            ...
            {"Tattoo Making","tattoo",
                    "Registration Fee: Rs. 20/- per team\n" +
                            " \n" +
            ...
            {"Face Painting","facepainting",
                    "Type : Team\n" +
                            ...
                            "Arun Kr. Gautam (9451318792)\n" +
                            "Rahul Srivastava (8182823380)"},
            {"Street Painting","streetpainting",
                    "Type : Team\n" +
                            "Registration Fee: Rs. 50/-\n" +
    ...
    static String manchan[][]={
            {"Street Play - Nukkad Natak","streetplay",
                    "Type: Group\n" +
    ...
    static String bandwars[][]={
            {"Band Wars","bandwarsevent",
                    "\u200B\n" +
    ...
    static String informals[][]=
            {
                    {"Roadies","rodies","Be creative, be brave.Fulfill tasks given to you to move forward into the game.Show the world that you can be a Roadie..."+"\n" +
                            "\n" +
                    ...
                    {"Fun Games","fungames","" +
                            ...
                            "Saurabh Rai\n" +
                            "(+91-9670478384)"},
                    {"Blind Date","blinddate","Meet new people on Blind Date.\n" +
                            "\n" +
                            "For further details contact -\n" +
                            "Shubham Kanojia\n" +
                            "(+91-8115366951)\n" +
                            "Saurabh Rai\n" +
                            "(+91-9670478384)"},
                    {"Scavenger Hunt","scavenger","Scavenger hunt is a party game in which a list is provided ,defining specific items, which the participants seek to gather or complete all items on the list, usually without purchasing them. \n\nBEG-BORROW-STEAL\n\nThose who brings most items in minimum time wins.\n\nType : Team"+"\n" +
                            "\n" +
                            "For further details contact -\n" +
                            "Shubham Kanojia\n" +
                            "(+91-8115366951)\n" +
